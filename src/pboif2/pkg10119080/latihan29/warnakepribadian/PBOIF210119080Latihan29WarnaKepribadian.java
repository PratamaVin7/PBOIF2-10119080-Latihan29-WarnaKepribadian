 ...
 */
package pboif2.pkg10119080.latihan29.warnakepribadian;
 ...
 * Warna Kepribadian
 */
public class PBOIF210119080Latihan29WarnaKepribadian {
     ...
     */
     public static void main(String[] args) {
        ...
        System.out.println(merah + "YUK " + hijau + "CEK " + kuning + 
                           "KEPRIBADIAN " + birumuda + "DARI " + ungu + "WARNA " 
                           + biru + "FAVORITMU" + normal);
        System.out.print("\n");
        ...
        switch (warna) {
            case ("MERAH"):
                ...
                System.out.println("3. Berani mengambil risiko dalam setiap"
                                   + " langkah,");
                ...
                System.out.println("6. Dapat menahan marah namun jika sudah "
                                   + "tahap puncak toleransi, kemarahannya akan "
                                   + "sulit dikontrol");
                System.out.println("7. Memiliki energi kehangatan dan cinta.");
                break;
            case ("HIJAU"):
                System.out.println("Warna Favoritmu adalah " + hijau + warna + 
                                   normal);
                System.out.println("1. Romantis,");
                System.out.println("2. Menyukai hal yang berbau alami dan "
                                   + "keindahan,");
                ...
                break;
            case ("KUNING"):
                System.out.println("Warna Favoritmu adalah " + kuning + warna + 
                                   normal);
                ...
                break;
            case ("BIRU"):
                System.out.println("Warna Favoritmu adalah " + biru + warna + 
                                   normal);
                System.out.println("1. Menyenangkan,");
                System.out.println("2. Bijaksana,");
                System.out.println("3. Pembawaan diri tenang saat menghadapi "
                                   + "masalah,");
                ...
                System.out.println("7. Tidak terlalu suka menjadi sorotan banyak "
                                   + "orang,");
                System.out.println("8. Menyembunyikan perasaan karena "
                                   + "karakternya yang cenderung mencari jalan "
                                   + "damai.");
                break;
            case ("UNGU"):
                System.out.println("Warna Favoritmu adalah " + ungu + warna + 
                                   normal);
                System.out.println("1. Optimis,");
                ...
                System.out.println("7. Terkadang bersikap keras kepala dan "
                                   + "angkuh,");
                break;
            default:
